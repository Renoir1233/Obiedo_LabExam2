        ...
        <div class="auth-body">
            ...
            <form method="POST" action="register.php">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" placeholder="Min 8 chars with uppercase, lowercase, number & special char"
                           required minlength="8">
                    <small style="color: #666666; font-size: 12px; display: block; margin-top: 4px;">
