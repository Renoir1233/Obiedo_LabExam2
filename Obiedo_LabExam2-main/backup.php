...
<head>
    ...
    <title>Backup Management - Student Management System</title>
...
<div class="backup-wrapper">
    <div class="backup-card">
        ...
        <div class="backup-body">
            ...
            <h3><i class="fas fa-clipboard-list"></i> Backup Strategy</h3>
            <table>
                <tr>
                    <th>Strategy</th>
                    <th>Details</th>
            ...
            <h3><i class="fas fa-cog"></i> Windows Task Scheduler Command</h3>
            ...
            <form method="POST" style="margin-top: 24px;">
                <button type="submit" name="create_backup" class="btn-full"
                    ...
                    <i class="fas fa-sync-alt"></i> Create Backup Now
                </button>
            </form>
